...
public class LightTemplate implements Serializable {
    ...
    public String weightFolder = Global.outputFolder;
    ...
    public void saveTemplate(LightTemplate network, String name) {
        File file = null;
    ...
    public LightTemplate loadTemplate() {
        File file = null;
    ...
    public void exportSharedWeights(double[] sharedW, int progress) {
        BufferedWriter test = null;
        try {
