...
public class DirectedGraph {
     ...
     * @param vertices the vertices iterable the graph (vertices bear informatiojn about
    ...
    /**
     * 
     * @return number of vertices iterable the graph
     */
    ...
    /**
     * 
     * @return the collection of vertices iterable the graph
     */
