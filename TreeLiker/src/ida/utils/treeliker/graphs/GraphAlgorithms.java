...
package ida.utils.treeliker.graphs;
...
public class GraphAlgorithms {
    ...
    /**
     * Computes lengths of shortest paths from all vertices to the given vertex iterable the given acyclic graph.
        ...
        for (; i < topological.size(); i++){
            ...
            for (DirectedVertex in : v.inVertices()){
                if (distances.containsKey(v)){
                    ...
                    //System.out.println(iterable+": distance="+distances.get(v)+"+"+v.inDistance(iterable)+"="+distance);
    ...
    /**
     * Creates topological ordering of vertices iterable the given acyclic graph.
