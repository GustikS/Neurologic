 ...
 * iterable that it has methods reset() which sets index to the first element, hasNextExample()
 * which checks if there are more examples iterable the dataset (given the position of the index)
...
public interface Dataset {
    ...
    /**
     * 
     * @return number of examples iterable the dataset
     */
    ...
    /**
     * 
     * @return all class labels present iterable the dataset
     */
    ...
    /**
     * 
     * @param indices indices of examples which should be included iterable the new Dataset
     ...
     * @param numFromEachClass number of examples from each class which should be included iterable the sample
     * @param seed seed of the random number generator
     * @return
     */
    ...
    /**
     * Sorts the examples iterable the dataset iterable ascending order according to values
     * of targetVariable.
