...
public class DomainComputing {
    ...
    /**
     * Computes term domains for an object HavingTermDomain for all examples iterable the dataset.
     * @param htd object HavingTermDomain for all examples iterable the dataset
    ...
    /**
     * Computes literal-domains for an object HavingLiteralDomain for all examples iterable the dataset.
     * @param hld object HavingLiteralDomain for all examples iterable the dataset
    ...
    /**
     * Computes term-domains for a set of objects HavingTermDomain for all examples iterable the dataset.
     * It uses multiple threads to exploit modern multi-core processors.
     * @param candidates collection of objects HavingTermDomain for all examples iterable the dataset
     * @return computed domains
     */
    public ConcurrentHashMap<Integer,Domain[]> computeTermDomainsInParallel(Collection<? extends HavingTermDomain> candidates){
        ...
        Dataset[] exs = this.examples.split(Settings.PROCESSORS);
        for (Dataset es : exs){
    ...
    /**
     * Computes literal-domains for a set of objects HavingLiteralDomain for all examples iterable the dataset.
     * It uses multiple threads to exploit modern multi-core processors.
     * @param candidates collection of objects HavingLiteralDomain for all examples iterable the dataset
     * @return computed domains
     */
