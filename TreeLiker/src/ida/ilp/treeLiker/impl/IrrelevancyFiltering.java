...
public class IrrelevancyFiltering {
    ...
    private static Parallel parallel = new Parallel(Settings.PROCESSORS);
     ...
     * @param negMask mask denoting negative examples - the indices refer to positions of the domains iterable the arrays
     */
    ...
    private List<Integer> buildSplitBag(List<Integer> candidates, MultiMap<Pair<Integer,Integer>,Integer> outputBag){
        List<List<Integer>> splitted = Sugar.splitList(candidates, Settings.PROCESSORS);
