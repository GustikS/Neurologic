...
public class BlockBuilder implements Runnable {
     ...
     * 
     * @param oldBlock the block which should be extended by adding various new combination of blocks (iterable the form of Joins) to one of its arguments.
     ...
     * @param literalDomains pre-computed domains of the combined blocks (this is actually being filled by methods iterable this class during their work)
