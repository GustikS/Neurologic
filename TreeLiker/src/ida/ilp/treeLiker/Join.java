...
public class Join implements Iterable<Block>, HavingTermDomain {
     ...
     * @param block one block iterable the Join
     */
    ...
    /**
     * Creates a new Join which contains all blocks originally contained iterable the old Join
     * plus the Block <em>block</em>
     * @param block the block to be added to the blocks iterable the join
     * @return the new Join
     */
    ...
    /**
     * 
     * @return first Block that is contained iterable this Join
     */
    public Block first(){
    ...
    /**
     * 
     * @return last Block that is contained iterable this Join
     */
    public Block last(){
        return this.block;
    }
     ...
     * applied on the blocks iterable the join.
     * 
     ...
     * the Aggregable computed using the cross-operation applied on the term-aggregables of blocks iterable
     * this Join.
     * 
     * @param term the term
     * @param e the example
     ...
     * of term-domains (the integer-set parts) of the blocks iterable this Join.
     * 
    ...
    /**
     * 
     * @return number of Blocks iterable this Join
     */
    ...
    /**
     * 
     * @return number of literals iterable this Join which is the sum of sizes of the blocks
     * iterable this Join
     */
    ...
    /**
     * 
     * @return number of aggregation-variables iterable this Join
     */
