...
public class Domain {
    ...
    /**
     * Computes cross-operation of domains iterable array <em>a</em> with the respctive
     * domains iterable array <em>b</em>. The cross opearation first computed intersection
     * of the integer-domains, then selectes the aggregables associated to the values
     * iterable the intersection of the integer-domains and computes the cross-operation defined
     * iterable interface Aggregable.
     * 
    ...
    /**
     * Selects a subset of domain according to values iterable IntegerSet selectedValues.
     ...
     * the values contained iterable the new integer-set.
     * 
     ...
     * @param a
     * @param b
     * @param mask - iterable which domains we are interested
    ...
    /**
     * Counts the number of non-empty domains iterable the given array - only the domains
     * at indices defined by the mask are counted.
     * @param domains array of domains
     * @param mask mask
     * @return number of non-empty domains iterable the given array - only the domains
     * at indices defined by the mask are counted.
     */
    ...
    /**
     * Counts the number of non-empty domains iterable given array.
     * @param domains array of domains
     * @return number of non-empty domains iterable the given array
     */
