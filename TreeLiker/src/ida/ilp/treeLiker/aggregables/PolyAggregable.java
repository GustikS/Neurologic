...
public class PolyAggregable implements Aggregable {
     ...
     * @param numVariables number of numerical variables iterable the monomials
     ...
     * and maximum degree, so we may create an ordering of the monomials an represented them implicitly by their position iterable the ordering)
     ...
     * and maximum degree, so we may create an ordering of the monomials an represented them implicitly by their position iterable the ordering.
     * This method gives us explicit representation of these monomials iterable terms of exponents of the individual variables
     * @param numVariables number of variables iterable the monomials
     * @param maxDegree maximum degree of the monomials
     * @return
     */
