 ...
 * of Lists iterable Java because it caches results of some operations (for example the hashCode etc)
 * which are often needed iterable operations with lists of aggregables. Moreover, there are some
 * very useful and fast sub-classes of this class for special variableTypes of aggregables (e.g. VoidAggregables).
 * 
 * @param <T> 
 * @author Ondra
 */
