...
public class Block implements HavingLiteralDomain, HavingTermDomain {
     ...
     * The predicate name, arity, variableTypes and modes of the arguments of this literal are given by the PredicateDefinition definition
     * @param definition specification of predicate name, arity, modes, variableTypes etc.
     */
     ...
     * is connected through its <em>input</em> argument which is specified iterable its PredicateDefinition object.
    ...
    /**
     * 
     * @return variableTypes according to PredicateDefinition
     */
    public int[] types(){
    ...
    /**
     * 
     * @return number of literals iterable this Block
     */
    public int size(){
        return this.size;
    }
    ...
    /**
     * 
     * @return number of aggregation-variables iterable this block
     */
    ...
    /**
     * Computes Aggregable which is the result of aggregation when the variables iterable the root are grounded
    ...
    public IntegerSet integerSetLiteralDomain(Example e){
        ...
        if (hasAtLeastOneChild){
            integerSetLiteralDomain = IntegerSet.intersection(literalDomains);
        } else {
     ...
     * for the variable iterable the input-argument of this Block.
     ...
     * 
     * Computes term-domain (including aggregables) of this Block w.r.t. example e. Term-domain is computed
     * for the variable iterable the position <em>argument</em> of this Block.
    ...
    /**
     * 
     * @return set of all predicates (represented as integers) present iterable this Block.
     */
    ...
    /**
     * 
     * @return frequencies (absolute = counts) of predicates iterable this Block (predicates represented as integers).
     */
    ...
    /**
     * Applies the given function on all Blocks iterable this Block (i.e. on children and children of children...)
...
//        //System.out.println(Block.parse("residue(A, asp), dist(A, _, B, _, 10.0), residue(B, val)"));
//    }
}
