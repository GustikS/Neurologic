...
import ida.ilp.treeLiker.aggregables.PolyAggregable;
import ida.ilp.treeLiker.aggregables.PolyAggregablesBuilder;
...
public class Poly {
   ...
   /**
    ...
    public Table<Integer,String> constructTable(List<Block> constructedFeatures){
        ...
        //missing values, i.e. monomials for which the features do not subsume the examples which results iterable empty sampling set
