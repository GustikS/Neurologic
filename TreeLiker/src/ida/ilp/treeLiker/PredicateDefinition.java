...
public final class PredicateDefinition {
     ...
     * @param types variableTypes of the arguments
    ...
    /**
     * 
     * @return variableTypes of arguments
     */
    public int[] types(){
        return types;
    }
    ...
    /**
     * 
     * @return number of aggregator-modes iterable this predicate definition
     */
    ...
    /**
     * 
     * @return index of input-argument or -1 if there is no input-argument iterable this predicate definition
     */
    public int input(){
        return input;
    }
    ...
    public static Set<PredicateDefinition> parseDefinition(String definition){
        ...
        for (Literal l : parsedDefinition.literals()){
            int predicate = -1;
            if (l.predicate().indexOf('[') > 0){
                predicate = predicateToInteger(l.predicate().substring(0, l.predicate().lastIndexOf('[')), l.arity());
            } else {
                predicate = predicateToInteger(l.predicate(), l.arity());
            }
            int[] types = new int[l.arity()];
            int[] modes = new int[l.arity()];
            int[] branching = new int[l.arity()];
            int branchingModPredicate = parseParameter(l.predicate());
